...
public class CarrierController extends BaseController {
    ...
    public ApiResult<List<Carrier>> list(
        ...
        return success(service.list(Wrappers.<Carrier>lambdaQuery()
    ...
    public ApiResult<Carrier> get(@PathVariable Long id) {
    ...
    public ApiResult<Carrier> update(@PathVariable Long id, @RequestBody Carrier entity) {
        required(id);
        entity.setId(id);
    ...
    private Carrier required(Long id) {
        ...
        if (entity == null) throw new ResourceNotFoundException("载具不存在: " + id);
        return entity;
    }
