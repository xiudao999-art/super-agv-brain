...
public class LabSpaceController extends BaseController {
    ...
    public ApiResult<List<LabSpaceSummary>> list() {
    ...
    public ApiResult<CreateLabSpaceResult> create(@Valid @RequestBody CreateLabSpaceRequest request) {
        return created(applicationService.createSpace(request));
    }

    @PutMapping("/{spaceId}")
    @Operation(summary = "修改空间名称")
    public ApiResult<Void> update(@PathVariable String spaceId,
    ...
    public ApiResult<CreateLabSpaceResult> createDraft(@PathVariable String spaceId) {
